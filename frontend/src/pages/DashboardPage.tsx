    ...
    <MainLayout>
      ...
      <div className="flex flex-col xl:flex-row gap-6">
        ...
        <div className="flex-1 min-w-0 space-y-6">
          ...
          {/* Map entry card */}
          <SpotlightCard className="w-full min-h-[360px] border border-blue-500/50 dark:border-blue-400/50 bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 flex flex-col items-center justify-center text-center p-8 group transition-all duration-300">
            ...
            <p className="relative z-10 text-slate-300 text-sm md:text-base max-w-lg leading-relaxed">
              Open the interactive map to inspect itinerary stops, destination markers, route timing, and trust status.
            </p>
